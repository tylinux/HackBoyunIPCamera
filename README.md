...
![IMG_0962](./Images/IMG_0962.jpg)

海思 HI3518CV100 的主控芯片
![IMG_0963](./Images/IMG_0963.jpg)

瑞昱 RTL8188ETV WiFi 模块
![](./Images/16226133621611.jpg)
...
![](./Images/16226166032691.jpg)

按照 OpenIPC 文档上的步骤：

1. 把下载好的 u-boot,kernle, rootfs 放到格式化成 fat32 的 TF 卡里: ✅
2. 上电后在 TTL Console 里按回车进入 u-boot 的终端：✅
3. 执行 `sf probe 0` 选定 SPI Flash 设备:✅
4. `mw.b 0x82000000 ff 1000000; fatload mmc 0:1 0x82000000 openwrt-hi35xx-XXXXX-u-boot.bin` 从 TF 卡加载 u-boot 镜像: ❌
...
| 0x200000 ~ 0x6FFFFF     | 5MB        | RootFS                  |
| 0x700000 ~ 0x7FFFFF     | 1MB        | Web 资源                 |
